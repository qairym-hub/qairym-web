        ...
        {open && (
          <div>
            ...
            <div className="py-4">
              {links.map((link) => {
                return (
                  <div key={link} className="d-flex align-items-center">
                    <Icon.Link45deg size="20" className="text-primary" />
          ...
          <div>
            {open ? (
              <div className="d-flex align-items-center">
                <Icon.ArrowUpCircleFill color="gray" size="18" />
                <div className="d-inline mx-1"></div>
                <span style={{ fontSize: "15px" }}>Свернуть</span>
              </div>
            ) : (
              <div className="d-flex align-items-center">
                <Icon.ArrowDownCircleFill color="gray" size="18" />
                <div className="d-inline mx-1"></div>
                <span style={{ fontSize: "15px" }}>Подробнее</span>
              </div>
            )}
          </div>
        </div>
